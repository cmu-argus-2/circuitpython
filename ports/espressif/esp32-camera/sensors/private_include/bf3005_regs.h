...
#if 0
#define GAIN                    0x00 /* AGC 每 Gain control gain setting  */
#define BLUE                    0x01 /* AWB 每 Blue channel gain setting  */
#define RED                     0x02 /* AWB 每 Red channel gain setting   */
#define GREEN                   0x03 /* AWB 每 Green channel gain setting */
#define BAVG                    0x05 /* U/B Average Level   */
#define GAVG                    0x06 /* Y/Gb Average Level  */
#define RAVG                    0x07 /* V/R Average Level   */
#define AECH                    0x08 /* Exposure Value 每 AEC MSBs */
...
#define REG_MIDH                    0x1C /* Manufacturer ID Byte 每 High */
#define REG_MIDL                    0x1D /* Manufacturer ID Byte 每 Low */
